...
<html>
  <head>
    ...
    <script type="text/javascript" src="{{asset ("/bower_components/AdminLTE/theme/js/jquery-1.11.3.js")}}"></script>
...
<script  src="{{ asset ("/bower_components/AdminLTE/plugins/slimScroll/jquery.slimscroll.min.js") }}" type="text/javascript" ></script>
<script type="text/javascript" src="{{asset ("/bower_components/AdminLTE/theme/js/html5.js")}}"></script>
<script type="text/javascript" src="{{asset ("/bower_components/AdminLTE/theme/js/bootstrap.js")}}"></script>
<script type="text/javascript" src="{{asset ("/bower_components/AdminLTE/theme/js/multiple-accordion.js")}}"></script>
<script type="text/javascript" src="{{asset ("/bower_components/AdminLTE/theme/js/jquery.nice-select.js")}}"></script>
<script type="text/javascript" src="{{asset ("/bower_components/AdminLTE/theme/js/jquery.bootstrap-responsive-tabs.js")}}"></script>
<script>
$(function() {
    var html = $('html, body'),
