...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
    <!-- Main Header -->
    @include('layouts.headerpartner')
    <!-- Sidebar -->
    @include('layouts.sidebarpartner')
    @yield('content')
    <!-- /.content-wrapper -->
    <!-- Footer -->
    ...
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
      <script src =" {{ asset("/bower_components/AdminLTE/bootstrap/js/jquery.min.js") }}" type="text/javascript"></script>
