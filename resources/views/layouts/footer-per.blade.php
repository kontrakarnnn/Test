  ...
  <footer class="main-footer">
    ...
    <div class="fb-page" data-href="https://www.facebook.com/wealththai.center/" data-tabs="messages" data-width="360" data-height="400" data-small-header="true" data-hide-cover="true" data-show-facepile="false">
    <blockquote cite="https://www.facebook.com/wealththai.center/" class="fb-xfbml-parse-ignore"> </blockquote>
    </div>
    <div class="fb-credit">
    <a href="https://wealththai.com" target="_blank">Facebook Chat Widget by Wealththai </a>
    </div>
    <div id="fb-root"></div>
    </div>
    <a href="https://m.me/wealththai.center" title="Send us a message on Facebook" class="ctrlq fb-button"></a>
    </div>
    ...
    <strong>Copyright &copy; <?php echo date("Y");?> <a href="#">Wealth Thai Academic Center</a></strong>
  </footer>
