...
|
*/
Route::get('/testrotate','TestrotateController@test');
...
Route::get('/admin', [
   ...
   Route::post('/admin/assign-roles', [
    ...
    Route::post('/import_excel/importcarinsurance', 'ImportExcelController@importotherinsurance');
    Route::post('/import_excel/importotherinsurance', 'ImportExcelController@importcarinsurance');
...
Route::get('/file/{id}/fakedelete','FileController@fakedelete');

Route::resource('/file', 'FileController');
Route::post('/file/search', 'FileController@search')->name('file.search');

Route::get('/showfile/{id}',['uses'=>'FileController@showfile']);
...
Route::post('/wealththaiinsurance/offer/store', 'OfferUserController@store')->name('offeruser.store');
Route::get('/wealththaiinsurance/get/offertype', 'OfferUserController@getoffertype');
Route::get('/wealththaiinsurance/get/campaign', 'OfferUserController@getcampaign');
Route::get('/wealththaiinsurance/get/promotion', 'OfferUserController@getpromotion');
Route::get('/wealththaiinsurance/get/proposalwherecaseid/{id}', 'OfferUserController@getproposalwhereccaseid');
Route::get('/wealththaiinsurance/get/membertypeorg', 'OfferUserController@getmembertypeorg');
Route::get('/wealththaiinsurance/get/branchwhereorg/{id}', 'OfferUserController@getbranchwhereorg');
Route::get('/wealththaiinsurance/get/offerwhereid/{id}', 'OfferUserController@offerwhereid');
...
Route::get('/wealththaiinsurance/show/fixasset', 'InsuranceController@showfixasset');
Route::get('/wealththaiinsurance/show/allfixasset', 'InsuranceController@showfixasset');
Route::get('/wealththaiinsurance/show/detailfixasset/{id}', 'InsuranceController@showdetailfixasset');
Route::get('/wealththaiinsurance/show/detailallfixasset/{id}', 'InsuranceController@showdetailfixasset');
...
Route::get('/wealththaiinsurance/load/getblockbystructure', 'InsuranceController@getblockbystructure');
Route::get('/wealththaiinsurance/load/compareday/{id}', 'InsuranceController@compareday');
...
Route::post('/wealththaiinsurance/copy/file', 'InsuranceController@copyfile');
...
Route::get('/maintenance' , function(){
    ...
    Route::get('reactsocket', 'FortestfunctionController@reactsocket');
